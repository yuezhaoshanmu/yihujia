import { Calendar, Pill, HeartPulse, Activity, ArrowRight, Verified, Utensils, PhoneCall, Loader2 } from 'lucide-react';
...
export default function HomeView({ onStartAppointment, onNavigate, onArticleClick, user }: HomeViewProps) {
